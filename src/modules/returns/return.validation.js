...
export const returnRefundSchema = z.object({ method: z.enum(["CASH", "CARD", "QR", "BANK", "OTHER"]), methodCode: z.string().trim().max(40).optional(), shiftId: z.uuid().nullable().optional(), note: z.string().max(500).optional() });
